...
<div class="role-form">
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <?php echo $form->field($model, 'name')->textInput(['maxlength' => true])->label(Module::t('roles', 'Name')) ?>

            <?php echo $form->field($model, 'description')->textInput(['maxlength' => true])->label(Module::t('roles', 'Description')) ?>
