...
<div class="permission-form">
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <?php echo $form->field($model, 'name')->textInput(['maxlength' => true])->label(Module::t('permissions', 'Name')) ?>

            <?php echo $form->field($model, 'description')->textInput(['maxlength' => true])->label(Module::t('permissions', 'Description')) ?>
